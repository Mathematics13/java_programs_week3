...
public class Program15_Wall
{
    ...
    {
        Program15_Wall wall = new Program15_Wall(5,4);
        System.out.println("area = " +wall.getArea());
        wall.setHeight(-1.5);
        System.out.println("width = " +wall.getWidth());
        System.out.println("height = " +wall.getHeight());
    ...
    public Program15_Wall()                                 //Default constructor
    {

    }

    public Program15_Wall(double width,double height)      //parametrized constructor
    {
        if (width<0)
        {
            this.width =0;
    ...
    public double getWidth()                               //get Width method
    {
        return width;
    }
    public double getHeight()                               //get Height method
    {
        return height;
    }
    public void setWidth(double width)                     //set Width method
    {
        if(width<0)
        {
            this.width =0;
    ...
    public void setHeight(double height)                     //set Height method
    {
        if(height<0)
        {
            this.height =0;
    ...
    public double getArea()                                   //Get Area method
    {
