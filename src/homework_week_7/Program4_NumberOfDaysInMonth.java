...
public class Program4_NumberOfDaysInMonth
{
    ...
    {
        System.out.println(isLeapYear(-1600));                                //leap year 4 outputs
    ...
    public static boolean isLeapYear(int years)                        //Checking is it leap year
    {
        boolean b;
    ...
    public static int getDaysInMonth(int month, int year)               //Calculating the days of the month depends on year
    {
        int days = 0;
